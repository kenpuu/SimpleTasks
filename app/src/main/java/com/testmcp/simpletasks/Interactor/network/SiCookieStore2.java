...
import com.testmcp.simpletasks.interactor.network.SICookie2;
...
public class SiCookieStore2 implements CookieStore {
    ...
    private static final String PACKAGE = "com.testmcp.simpletasks.interactor.network";
    private static final String COOKIE_PREFS = PACKAGE + ".cookieprefs";
    private static final String COOKIE_DOMAINS_STORE = PACKAGE + ".domain";
    private static final String COOKIE_DOMAIN_PREFIX = PACKAGE + ".domain_";
    private static final String COOKIE_NAME_PREFIX = PACKAGE + ".cookie_";
